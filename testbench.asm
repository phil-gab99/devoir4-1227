...
tag4:   sw      $8, 75($0)      # $8(1) -> M[75 + $0(0) = 75] Test #16 - jal
        sw      $31, 76($0)     # $31(148) -> M[76 + $0(0) = 76] Test #17 - jal
        addi    $10, $0, 43     # $10(11) = $0 + 43 = 43
        jr      $10             # goto $10
        addi    $8, $8, -5      # $8(1) = $8(1) - 5 = -4 EXPECTED TO SKIP
        
        bNal    $8, tag5        # if $8(1) is negative, goto tag5
        addi    $8, $8, -7      # $8(1) = $8(1) - 7 = -6
tag5:   sw      $8, 77($0)      # $8(-6) -> M[77 + $0(0) = 77] Test #18 - bNal and jr
        sw      $31, 78($0)     # $31(148) -> M[78 + $0(0) = 78] Test #19 - bNal
        bNal    $8, tag6        # if $8(-6) is negative, goto tag6
        addi    $8, $0, 5       # $8(-6) = $0(0) + 5 = 5 EXPECTED TO SKIP
tag6:   sw      $8, 79($0)      # $8(-6) -> M[79 + $0(0) = 79] Test #20 - bNal
        sw      $31, 80($0)     # $31(192) -> M[80 + $0(0) = 80] Test #21 - bNal